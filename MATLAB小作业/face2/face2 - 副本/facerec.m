...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%            不适用教科书上的传统方法进行人脸检测，转而使用vision类的预训练模型进行人脸识别     %               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% 读取输入图像
inputImage = imread('16.png'); % 请替换为实际的图像文件路径
...
faceDetector.ScaleFactor = 1.3; % 调整检测尺度因子
...
% 读取大图和模板图像
% 读取图像
largeImage = imread('16.png'); % 替换为实际大图路径
templateImage = imread('17.png'); % 替换为实际模板图像路径
